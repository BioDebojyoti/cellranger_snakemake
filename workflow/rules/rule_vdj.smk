...
fastq_df_vdj = pd.read_csv(config["paths2fastq4vdj_file"])
...
vdj_outdir = config["output_vdj"]

vdj_cores = config["resources"]["localcores"]
vdj_memory = config["resources"]["localmem"]
